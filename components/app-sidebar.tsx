            ...
            <div key={group.label} className="mb-2">
              {!isCollapsed ? (
                <button
                  ...
                  className="mb-1 flex w-full items-center justify-between rounded-md px-3 py-1.5 text-[11px] font-bold uppercase tracking-wider text-cyan-600 transition-colors hover:text-cyan-700 dark:text-cyan-500/80 dark:hover:text-cyan-400"
                >

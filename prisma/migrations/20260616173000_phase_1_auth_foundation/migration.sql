...
CREATE TABLE `Role` (
    `id` VARCHAR(191) NOT NULL,
    `companyId` VARCHAR(191) NULL,
    `code` ENUM('SUPER_ADMIN', 'COMPANY_ADMIN', 'OPERATIONS_MANAGER', 'DOCUMENTATION_OFFICER', 'ACCOUNTS_OFFICER', 'SALES_EXECUTIVE', 'CLIENT_USER') NOT NULL,
    `name` VARCHAR(191) NOT NULL,
    ...
    UNIQUE INDEX `Role_companyId_code_key`(`companyId`, `code`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
